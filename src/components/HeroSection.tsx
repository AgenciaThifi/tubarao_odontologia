...
const HeroSection = () => {
  return (
    <section className="relative bg-[#038dff] min-h-[600px] overflow-hidden">
      {/* Background Image */}
      <div 
        className="absolute inset-0 opacity-30 bg-cover bg-center"
        style={{
          backgroundImage: `url('https://images.pexels.com/photos/3845625/pexels-photo-3845625.jpeg')`
        }}
      />
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-white max-w-xl mb-8 md:mb-0">
            ...
            <Link 
              href="#agendar"
              className="inline-flex items-center bg-white text-[#038dff] px-8 py-3 rounded-lg font-bold text-lg hover:bg-opacity-90 transition-all"
            >
              Agendar Avaliação
              <svg 
