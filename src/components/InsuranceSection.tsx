...
const LogoCard = ({ src, alt }: { src: string; alt: string }) => (
  <div className="bg-white rounded-2xl p-4 flex items-center justify-center shadow-sm h-[100px] md:h-[80px]">
    <div className="relative w-[120px] md:w-[100px] h-[80px] md:h-[60px]">
      <Image
        src={src}
        alt={alt}
        fill
        ...
        <div className="bg-[#038dff] rounded-3xl shadow-lg px-6 py-8 max-w-6xl mx-auto">
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Top Row */}
              {insuranceLogos.top.map((logo, index) => (
